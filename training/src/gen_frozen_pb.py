...
for i in range(30):
    args.model = 'zq3_cpm'
    args.size=192
    args.checkpoint='C:/PoseEstimationForMobile/trained/zq3_cpm_tiny/log/zq3_cpm_batch-20_lr-0.001_gpus-1_192x192_experiments-zq3_cpm/model-%d0000'%(i+1)
    args.output_node_names='CPM/stage_2_out'
    args.output_graph='models/zq3-model-%d0000.pb'%(i+1)
    

    export_one_model(args)
